...
/***/ function(module, exports, __webpack_require__) {
	...
	_routerConfig2.default.user(router);

	router.start(_user2.default, 'app');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] vendor/container/user.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js!./../../node_modules/.npminstall/vue-loader/8.5.2/vue-loader/lib/style-rewriter.js?id=_v-65d606dc&scoped=true!./../../node_modules/.npminstall/vue-loader/8.5.2/vue-loader/lib/selector.js?type=style&index=0!./user.vue", function() {
				var newContent = require("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js!./../../node_modules/.npminstall/vue-loader/8.5.2/vue-loader/lib/style-rewriter.js?id=_v-65d606dc&scoped=true!./../../node_modules/.npminstall/vue-loader/8.5.2/vue-loader/lib/selector.js?type=style&index=0!./user.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.view[_v-65d606dc] {\n  -webkit-transition: all .5s ease;\n  transition: all .5s ease;\n}\n.test-enter[_v-65d606dc], .test-leave[_v-65d606dc] {\n  opacity: 0;\n  -webkit-transform: translate3d(10px, 0, 0);\n          transform: translate3d(10px, 0, 0);\n}\n.v-link-active[_v-65d606dc] {\n  color: red;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"pagehome clearfix\" style=\"height:100%;height:auto; min-height:100%;\" _v-65d606dc=\"\">\n  <header-top v-if=\"!(!!$route.name &amp;&amp; $route.name == 'room')\" _v-65d606dc=\"\"></header-top>\n  <div class=\"main\" style=\"min-height: 129px;\" _v-65d606dc=\"\">\n    <div class=\"main-auto clearfix\" _v-65d606dc=\"\">\n      <div class=\"left\" avalonctrl=\"userleft\" _v-65d606dc=\"\">\n        <dl class=\"zb-info clearfix\" _v-65d606dc=\"\">\n          <dt class=\"inmg\" _v-65d606dc=\"\">\n            <img id=\"user_photo_1\" align=\"absmiddle\" style=\"width: 55px; height: 55px\" src=\"http://image.cache.xiu8.com/avatar/55/55/198882173.jpg?_=1461504922383\" _v-65d606dc=\"\">\n          </dt>\n          <dd _v-65d606dc=\"\">\n            <p _v-65d606dc=\"\">\n              <a href=\"javascript:void(0)\" class=\"name\" style=\"height:20px;line-height:20px;\" _v-65d606dc=\"\">{{user.nickname}}\n              </a> \n              <b class=\"purple\" _v-65d606dc=\"\">{{user.id}}</b>\n            </p>\n            <p class=\"mt5\" _v-65d606dc=\"\">\n               <span class=\"ul ul{{user.userlevel>9?user.userlevel:'0'+user.userlevel}}\" _v-65d606dc=\"\"></span>\n            </p>\n          </dd>\n        </dl>\n        <div class=\"user-msg\" _v-65d606dc=\"\">\n          <p id=\"p1\" class=\"title\" :class=\"{'cur-tit': selfTab}\" @click=\"explan(0)\" _v-65d606dc=\"\">\n            <s _v-65d606dc=\"\"></s>我的秀吧<i id=\"i1\" class=\"os\" _v-65d606dc=\"\"></i>\n          </p>\n          <ul id=\"u1\" v-if=\"selfTab\" _v-65d606dc=\"\">\n            <li :class=\"{cur: $route.path =='/user/info'}\" _v-65d606dc=\"\"><a v-link=\"{path: '/user/info'}\" class=\"ma\" _v-65d606dc=\"\">个人设置</a></li>\n            <li :class=\"{cur: $route.path =='/user/password'}\" _v-65d606dc=\"\"><a v-link=\"{path: '/user/password'}\" class=\"me\" _v-65d606dc=\"\">修改密码</a></li>\n            <li :class=\"{cur: $route.path =='/user/tips'}\" _v-65d606dc=\"\"><a v-link=\"{path: '/user/tips'}\" class=\"mc\" _v-65d606dc=\"\">系统消息</a></li>\n            <li :class=\"{cur: $route.path =='/user/myAttention'}\" _v-65d606dc=\"\"><a v-link=\"{path: '/user/myAttention'}\" class=\"md\" _v-65d606dc=\"\">我的关注</a></li>\n            <li :class=\"{cur: $route.path =='/user/vip'}\" _v-65d606dc=\"\"><a v-link=\"{path: '/user/vip'}\" class=\"mf\" _v-65d606dc=\"\">我的VIP</a></li>\n            <li :class=\"{cur: $route.path =='/user/number'}\" _v-65d606dc=\"\"><a v-link=\"{path: '/user/number'}\" class=\"mg\" _v-65d606dc=\"\">我的靓号</a></li>\n            <li :class=\"{cur: $route.path =='/user/car'}\" _v-65d606dc=\"\"><a v-link=\"{path: '/user/car'}\" class=\"mh\" _v-65d606dc=\"\">我的座驾</a></li>\n            <li :class=\"{cur: $route.path =='/user/defence'}\" _v-65d606dc=\"\"><a v-link=\"{path: '/user/defence'}\" class=\"ml\" _v-65d606dc=\"\">我的守护</a></li>\n            <!-- <li :class=\"{cur: $route.path =='/user/medal'}\"><a v-link=\"{path: '/user/medal'}\" class=\"ml\">我的徽章</a></li> -->\n          </ul>\n        </div>\n        <div class=\"user-msg\" _v-65d606dc=\"\">\n          <p id=\"p2\" class=\"title\" :class=\"{'cur-tit': selfTab}\" @click=\"explan(1)\" _v-65d606dc=\"\">\n            <s _v-65d606dc=\"\"></s>我的财富<i id=\"i2\" _v-65d606dc=\"\"></i>\n          </p>\n          <ul id=\"u2\" v-if=\"moneyTab\" _v-65d606dc=\"\">\n            <li _v-65d606dc=\"\"><a href=\"/user/wealth/recharge\" class=\"mi\" _v-65d606dc=\"\">充值查询</a></li>\n            <li _v-65d606dc=\"\"><a href=\"/user/wealth/sendgift\" class=\"mj\" _v-65d606dc=\"\">送礼记录</a></li>\n            <li _v-65d606dc=\"\"><a href=\"/user/wealth/receivegift\" class=\"mk\" _v-65d606dc=\"\">收礼记录</a></li>     \n            <li _v-65d606dc=\"\"><a href=\"/user/wealth/gameCoin\" class=\"mk\" _v-65d606dc=\"\">兑游戏币</a></li>\n          </ul>\n        </div>\n\n        <div class=\"user-msg\" _v-65d606dc=\"\">\n          <!--公会管理-->\n          <!--ms-if-->\n          <!--ms-if-->\n          <!--我的家族-->\n          <!--<p id=\"p10\" class=\"title\">\n            <s></s>我的家族<i id=\"i10\"></i>\n          </p>\n          <ul id=\"u10\" v-if=\"famliyTab\">\n            <li><a href=\"/clan/initial\" class=\"mj\">我的家族</a></li>\n          </ul>-->\n        </div> \n      \n      </div>\n      <div class=\"right\" _v-65d606dc=\"\">\n        <router-view keep-alive=\"\" _v-65d606dc=\"\"></router-view>\n      </div>\n      \n    </div>\n  </div>\n  \n</div>\n<footer-bottom v-if=\"!(!!$route.name &amp;&amp; $route.name == 'room')\" _v-65d606dc=\"\"></footer-bottom>\n";
